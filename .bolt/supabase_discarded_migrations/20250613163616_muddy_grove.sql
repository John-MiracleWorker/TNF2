/*
  ...
  1. New Tables
    - `bible_reading_plans`: Stores reading plan details
      - `id` (uuid, primary key)
      - `title` (text)
      - `description` (text)
    ...
    - `plan_daily_readings`: Maps each day to specific scripture passages
      - `id` (uuid, primary key)
      - `plan_id` (uuid, references bible_reading_plans)
      - `day_number` (integer)
      - `title` (text)
      - `description` (text)
    ...
    - `user_reading_progress`: Tracks user progress through plans
      - `id` (uuid, primary key)
    ...
    - `reading_reflections`: Stores user reflections on daily readings
      - `id` (uuid, primary key)
      - `user_id` (uuid, references auth.users)
      - `plan_id` (uuid, references bible_reading_plans)
      - `day_number` (integer)
  ...
  2. Security
    ...
    - Reading plans are publicly viewable
    - User progress and reflections are private to each user
*/
